...
bool brute_force_gpu(std::string charset, unsigned char* target_hash, int max_len, std::vector<int> hash_sequence, char* result) {
...
int main(int argc, char* argv[]) {
    ...
    bool found  = brute_force_gpu(charset_str, target_hash, int max_len, hash_sequence, char* result);
    // Stop timer
